...
5.  **Formatting**: Use formatting (e.g., bullet points, bolding) to improve readability in your main answer.

6.  **References Format**: After providing your complete answer, add a separate "References" section at the very end that lists all source documents and page numbers used. Format this as:
